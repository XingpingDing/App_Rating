...
from AppRating.models import Category, App, Comment
...
def populate():
    ...
    user1 = add_user(username='leifos', password='leifos')
    user2 = add_user(username='laura', password='laura')
    user3 = add_user(username='david', password='david')
    user4 = add_user(username='louis', password='louis')
    ...
    add_comment(user=user1, app=app1, score=4, content='nice')
    add_comment(user=user1, app=app2, score=4, content='nice')
    add_comment(user=user1, app=app3, score=5, content='well done')
    add_comment(user=user2, app=app4, score=5, content='Perfect')
    add_comment(user=user2, app=app5, score=5, content='Perfect')
    add_comment(user=user3, app=app6, score=3, content='not good')
    add_comment(user=user4, app=app7, score=5, content='wow')
    add_comment(user=user4, app=app8, score=5, content='wow')


def add_app(appid, appname, category, description, developer, price, iconpath, imagepath1, imagepath2, imagepath3,
            averscore=0, viewcount=0, likecount=0, dislikecount=0):
